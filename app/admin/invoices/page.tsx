...
export default function AdminInvoicesPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // Lấy danh sách hóa đơn (nhớ .data vì backend trả về phân trang)
      ...
      // Lấy danh sách phòng để cho vào ô Select (nhớ .data vì backend phân trang)
  ...
  // Kích hoạt quét quá hạn thủ công
